...
int main(){
    ...
    if(total>=80){
        printf("Student's Grade = 4 (A+)\n");
    }
    else if(total>=75){
        printf("Student's Grade = 3.75 (A)\n");
    }
    else if(total>=70){
        printf("Student's Grade = 3.50 (A-)\n");
    }
    else if(total>=65){
        printf("Student's Grade = 3.25 (B+)\n");
    }
    else if(total>=60){
        printf("Student's Grade = 3.00 (B)\n");
    }
    else if(total>=55){
        printf("Student's Grade = 2.75 B-)\n");
    }
    else if(total>=50){
        printf("Student's Grade = 2.50 (C+)\n");
    }
    else if(total>=45){
        printf("Student's Grade = 2.25 (C)\n");
    }
    else if(total>=40){
        printf("Student's Grade = 2.00 (D)\n");
    }
    else{
        printf("Student's Grade = 0.00 (Fail)\n");
    }
